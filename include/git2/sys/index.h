 ...
 */
GIT_EXTERN(size_t)
git_index_name_entrycount(git_index
*index);
...
git_index_name_clear(git_index
*index);
 ...
 */
GIT_EXTERN(size_t)
git_index_reuc_entrycount(git_index
*index);
...
git_index_reuc_get_bypath(git_index
*index,
const char *path
);
...
git_index_reuc_get_byindex(git_index
*index,
size_t n
);
...
git_index_reuc_remove(git_index
*index,
size_t n
);
...
git_index_reuc_clear(git_index
*index);
