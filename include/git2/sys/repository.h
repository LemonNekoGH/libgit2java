...
git_repository_new(git_repository
**out);
...
git_repository__cleanup(git_repository
*repo);
...
git_repository_set_config(git_repository
*repo,
git_config *config
);
...
git_repository_set_odb(git_repository
*repo,
git_odb *odb
);
...
git_repository_set_refdb(git_repository
*repo,
git_refdb *refdb
);
...
git_repository_set_index(git_repository
*repo,
git_index *index
);
...
git_repository_set_bare(git_repository
*repo);
