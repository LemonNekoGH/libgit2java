...
git_transport_new(git_transport
**out,
git_remote *owner,
const char *url
);
...
git_transport_ssh_with_paths(git_transport
**out,
git_remote *owner,
void *payload
);
...
git_transport_smart_certificate_check(git_transport
*transport,
git_cert *cert,
int valid,
const char *hostname
...
git_transport_smart_credentials(git_credential
**out,
git_transport *transport,
const char *user,
int methods
...
git_transport_smart_proxy_options(git_proxy_options
*out,
git_transport *transport
);
